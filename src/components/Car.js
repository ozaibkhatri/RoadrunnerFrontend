...
const Car = ({ car }) => {
  ...
  return (
    <div className='carpage'>
      ...
      <button style={{marginLeft:"800px",backgroundColor:"black",color:"white",height:"40px",borderRadius:"15px",cursor:"pointer",marginBottom:"10px"}}onClick={handleClick}>Rent Me Now</button>
      {/* </Link> */}
